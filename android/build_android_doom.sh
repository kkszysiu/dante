...
CC=$CC CXX=$CXX RANLIB=$RANLIB AR=$AR LD=$LD scons -j7 arch=arm system=Android CC=$CC CXX=$CXX RANLIB=$RANLIB AR=$AR BASEFLAGS=$CPPFLAGS NOCURL=1 ALSA=0 BUILD_GAMEPAK=1 $@
